...
cfg = {...
    'percentile-whole-brain',0.1,0.1,6;...
    'percentile-whole-brain',0.2,0.1,6;...
    'percentile-whole-brain',0.3,0.1,6;...
    'percentile-whole-brain',0.1,0.2,6;...
    'percentile-whole-brain',0.1,0.3,6;...
    'percentile-whole-brain',0.1,0.4,6;...
    'percentile-whole-brain',0.1,0.1,4;...
    'percentile-whole-brain',0.1,0.1,3;...
    'percentile-whole-brain',0.1,0.1,2;...
    };

spm_ss_estimate(spm_ss_design(struct(...
            'swd',strcat(pwd,'/LanA_GSS_SN_reduced_subjects_percentile-whole-brain_',join(cellfun(@num2str,cfg(i,2:4),'UniformOutput',false),'_')),...
